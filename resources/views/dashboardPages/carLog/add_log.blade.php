                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="row">
                                      <div class="form-group role_main_div col-md-6 col-sm-12">
                                        ...
                                        <select name="vehicle_id" id="vehicle_id" class=" show-tick ms select2 w-100 vehicles">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control date_field" placeholder="Log Date" name="log_date" id="log_date" value="{{old('log_date')}}" />
                                            @error('log_date')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        <div class="form-group role_main_div col-md-6 col-sm-12">
                                        <label>From</label> 
                                        <input type="text" class="form-control" placeholder="From" name="from" id="from" value="{{old('from')}}" />
                                            @error('from')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group role_main_div col-md-6 col-sm-12">
                                        <label>To</label> 
                                        <input type="text" class="form-control" placeholder="to" name="to" id="to" value="{{old('to')}}" />
                                            @error('to')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <input type="number" class="form-control" placeholder="Distance" name="distance" id="distance" value="{{old('distance')}}" />
                                            @error('distance')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="number" class="form-control" placeholder="Fuel" name="fuel" id="fuel" value="{{old('fuel')}}" />
                                            @error('fuel')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        <div class="form-group role_main_div  col-md-6 col-sm-12">
                                        <label>Comment</label> 
                                        <input type="text" class="form-control" placeholder="Comment" name="comment" id="comment" value="{{old('comment')}}" />
                                            @error('comment')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
