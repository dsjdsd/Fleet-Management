        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form name="frm" class="range_form" method="POST" action="{{route('create_range_master')}}">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group role_main_div col-md-6 col-sm-12">     
                                        <label>Range</label>                              
                                            <input type="text" class="form-control" placeholder="Range" name="range" id="range" value="{{old('role')}}" />
