                        ...
                        <div class="body">
                            ...
                            <div class="row">
                                <div class="form-group make_main_div col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="district" placeholder="Enter District Name" value="{{old('district')}}">
                                ...
                                <div class="form-group make_main_div col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" name="district_code" placeholder="Enter District Code" value="{{old('district_code')}}">
                                ...
                                <div class="form-group make_main_div">
                                    ...
                                    <input type="text" class="form-control" name="district_headquarter" placeholder="Enter District HeadQuarter" value="{{old('district_headquarter')}}">
