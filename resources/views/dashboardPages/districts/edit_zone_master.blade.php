        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            <form name="frm" class="zone_form" method="POST" action="{{route('update_zone_master')}}">
                                @csrf
                                <div class="row clearfix">
                                    <div class="form-group role_main_div col-md-6 col-sm-12"> 
                                        ...
                                        <div class="form-grouprole_main_div">        
                                            <select class="form-control show-tick ms select2" name="commissionrate" id="commissionrate">
                                                ...
                                                <option value="{{$val->id}}" {{old('commissionrate')==$val->id ? 'selected' : ($zone_data->commissionrate_id==$val->id ? 'selected' : '')}}>{{$val->comissionrate_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group role_main_div col-md-6 col-sm-12"> 
                                        <label>Zone</label>
                                        <div class="form-grouprole_main_div">        
                                            <input type="text" class="form-control" placeholder="Zone" name="zone" id="zone" value="{{old('zone') ? old('zone') : $zone_data->zone}}" />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group text-right">  
                                            <input type="hidden" name="zone_id" value="{{Crypt::encryptString($zone_data->id)}}"/>
