                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <form name="frm" class="add_task_form" method="POST" action="{{route('create_task')}}">
                                @csrf
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="row">
                                        ...
                                        <input type="text" class="form-control date_field" placeholder="Assigned On" name="assined_on" id="assined_on" value="{{old('assined_on')}}" />
                                            @error('assined_on')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <label>Task</label> 
                                        <input type="text" class="form-control" placeholder="Task Title" name="task" id="task" value="{{old('task')}}" />
                                            @error('task')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
