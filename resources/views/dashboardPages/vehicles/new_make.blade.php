                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="form-group role_main_div col-md-6 col-sm-12">  
                                            <label>Make</label>                                  
                                            <input type="text" class="form-control" placeholder="Make" name="make" id="make" value="{{old('make')}}" />
...
<script>
$(function(){
    var selected_vehicle_type="{{old('vehicle_type')}}";
        ...
        rules: {
            ...
            special_purpose_vehicles: {
                required: function(element) {
                    return $("#vehicle_type").val() === "Special Purpose Vehicles";
                }
            }
        },
        messages: {
