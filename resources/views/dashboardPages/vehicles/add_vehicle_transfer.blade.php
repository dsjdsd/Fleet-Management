                                ...
                                <div class="row clearfix">
                                   ...
                                   <div class="row">
                                        ...
                                        <select  id="transfer_type" name="transfer_type" class=" form-control show-tick ms">
                                            ...
                                            <option value="Permanent" <?php if(old('transfer_type')=="Permanent"){echo "selected";}?>>Permanent</option>
                                            <option value="For Duty" <?php if(old('transfer_type')=="For Duty"){echo "selected";}?>>For Duty</option>
                                        </select>
                                            @error('transfer_type')
								                <label class="error help-block">{{ $message }}</label>
                			                @enderror
                                    ...
                                    <div class="row transfer_date_range" style="<?php if(old('transfer_type')=="For Duty"){echo "";}else{echo "display:none; ";}?>">
                                        <div class="form-group role_main_div col-md-6 col-sm-12">
                                            <label>From Date</label> 
                                            <input type="text" class="form-control date_field" placeholder="From Date" name="from" id="from" value="{{old('from')}}" />
                                                @error('from')
                                                    <label class="error help-block">{{ $message }}</label>
                                                @enderror
                                            </div>
                                                <div class="form-group role_main_div col-md-6 col-sm-12">
                                            <label>To Date</label> 
                                            <input type="text" class="form-control date_field" placeholder="To Date" name="to" id="to" value="{{old('to')}}" />
                                                @error('to')
                                                    <label class="error help-block">{{ $message }}</label>
                                                @enderror
                                            </div>
