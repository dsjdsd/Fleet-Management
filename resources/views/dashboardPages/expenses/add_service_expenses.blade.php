                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="row">
                                      <div class="form-group role_main_div col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control date_field" placeholder="Service Date" name="service_date" id="service_date" value="{{old('service_date')}}" />
                                            @error('service_date')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
