                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="row">
                                      <div class="form-group role_main_div col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control date_field" placeholder="Repair Date" name="repair_date" id="repair_date" value="{{old('repair_date')}}" />
                                            @error('repair_date')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
