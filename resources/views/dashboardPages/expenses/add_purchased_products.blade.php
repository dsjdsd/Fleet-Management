                                    ...
                                    <div class="row">
                                      <div class="form-group role_main_div col-md-6 col-sm-12">
                                        <label>Vehicle Number</label>
                                            ...
                                            <option value="{{$vehicle->id}}" <?php if(old('vehicle_id')==$vehicle->id){echo"selected";}?>>{{$vehicle->registration_number}}</option>
                                            @endforeach
                                            </select>
                                            @error('vehicle_id')
                                        ...
                                        <label>Driver</label> 
                                            <select name="driver_id" id="driver_id" class="w-100 show-tick ms select2">
                                                ...
                                                <option value="{{$driver->id}}" <?php if(old('driver_id')==$driver->id){echo"selected";}?>>{{$driver->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('driver_id')
                                                <label class="error help-block">{{ $message }}</label>
                                        ...
                                        <input type="text" name="pno_number" readonly class="form-control" placeholder="PNO Number" id="pno_number" value="{{old('pno_number')}}"> 
                                            @error('pno_number')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <input type="number" class="form-control" placeholder="Cost" name="cost" id="cost" value="{{old('cost')}}" />
                                            @error('cost')
                                                <label class="error help-block">{{ $message }}</label>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" class="form-control date_field" placeholder="Purchase Date" name="purchase_date" id="purchase_date" value="{{old('purchase_date')}}" />
                                                @error('purchase_date')
                                                    <label class="error help-block">{{ $message }}</label>
                                                @enderror
                                            </div>
                                            ...
                                            <input type="text" class="form-control" placeholder="Purchased Item" name="purchase_item" id="purchase_item" value="{{old('purchase_item')}}" />
                                                @error('purchase_item')
                                                    <label class="error help-block">{{ $message }}</label>
                                                @enderror
                                            </div>
